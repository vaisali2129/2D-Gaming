var destroyer = {
	create: function () {
		...
		this.buton.onInputOver.add(this.over, this);
        this.buton.onInputOut.add(this.out, this);
		...
		//health label
		this.bmpText1 = game.add.bitmapText(game.width / 2, 140, 'fontUsed', '', 150);
	...
	killPlayer: function (player) {
		...
		game.globals.health=game.globals.health-1;
		this.sound.kill.play('', 0, 0.5, false);
		if(game.globals.health<90)
		{
